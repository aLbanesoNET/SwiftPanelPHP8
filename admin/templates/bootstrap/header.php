...
<body>
<div id="topbg"></div>
<button type="button" id="navtoggle" aria-label="Menu" onclick="document.getElementById('nav').classList.toggle('open')"><i class="bi bi-list"></i></button>
<div id="nav"> <a href="index.php" title="Home" id="navhome"><span>Swift Panel</span></a>
  <?php if ($page != "login"): ?>
  <div id="navleft">
