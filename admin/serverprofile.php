...
$hiddens = array("task" => "serverprofile", "serverid" => $rows["serverid"]);
$inputs = array("name" => array("text", "Name", 30), "game" => array("text", "Game", 30), "status" => array("radio", "Status", array("Pending", "Active", "Suspended")), array("divider"), "priority" => array("select", "Priority", array("None" => "None", "Very High" => "Very High", "High" => "High", "Above Normal" => "Above Normal", "Normal" => "Normal", "Below Normal" => "Below Normal", "Low" => "Low", "Very Low" => "Very Low")), "slots" => array("text", "Max Slots", 5, "{slots}"), "type" => array("radio", "Type", array("Public", "Private")), array("cfg", 8), "startline" => array("textarea", "Start Command", 60, 4), array("divider"), "showftp" => array("checkbox", "Display FTP Login Details"), "webftp" => array("checkbox", "Allow Web FTP Access"));
